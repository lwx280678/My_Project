...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "FileView";
	 ...
	 * relative path
	 * 
	 * 根据路径返回相对于插件类的ImageDescriptor，这个方法很重要 很多时候设置图片或者ImageDescriptor都是调用这个方法
	 * 有一个好处就是这种方法是采用相对路径得到的 注意path的写法，如果是在项目下的icons目录中，应该是 /icons/XX.ico
	 * 
	 * Returns an image descriptor for the image file at the given plug-in
	 * relative path
	 * 
